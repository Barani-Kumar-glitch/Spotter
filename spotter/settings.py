...
ALLOWED_HOSTS = os.getenv(
    "ALLOWED_HOSTS",
    "127.0.0.1,localhost,spotter-1-ukhq.onrender.com"
).split(",")
...
#         'PASSWORD': os.getenv('DB_PASSWORD'), # Safe from GitHub!
...
# hari updated database settings
...
if DATABASE_URL:
    ...
    # Only force SSL if we are NOT running on our local machine
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.getenv('DB_PASSWORD', 'Barani@2005'),
...
LOGIN_URL = 'signup'  # The 'name' from your urls.py
...
# The URL used to access media in the browser
MEDIA_URL = '/media/'
